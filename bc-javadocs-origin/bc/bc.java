...
public class bc {
  /**
   * Returns the other planet given this planet.
   */
  ...
  /**
   * Returns if the two given planets are equal.
   */
  ...
  /**
   * Returns the change in the x-direction for the given direction.
   */
  ...
  /**
   * Returns the change in the y-direction for the given direction.
   */
  ...
  /**
   * Returns if the direction is diagonal.
   */
  ...
  /**
   * Returns the direction rotated by 45 degrees counter-clockwise.
   */
  ...
  /**
   * Returns the direction rotated by 45 degrees clockwise.
   */
  ...
  /**
   * Returns a Location object constructed from the given MapLocation.
   */
  ...
  /**
   * Returns a new location in a garrison.
   */
  ...
  /**
   * Returns a new location in space.
   */
  ...
  /**
   * Returns the cost to build this unit type in a factory.
   */
  ...
  /**
   * Returns the cost to blueprint this unit type.
   */
  ...
  /**
   * Returns the cost for this unit type to replicate.
   */
  ...
  /**
   * Returns the value of this unit type.
   */
...
//  }
  ...
  /**
   * Returns the maximum upgrade level for the given unit type.
   */
  ...
  /**
   * Returns the cost for to upgrade the given unit type to the given level.
   */
